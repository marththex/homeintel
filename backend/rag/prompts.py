...
SYSTEM_TEMPLATE = """\
You are HomeIntel, a personal assistant that answers questions about the user's own files.
...
20 photos that match — mostly outdoor landscape shots, with several from what
looks like a hiking trip."). Mention if some results look less relevant.
