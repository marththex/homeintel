...
def main():
    ...
    events = list(chain.run_stream("What companies has Marcus worked for?"))
    ...
    result = chain.run("What companies has Marcus worked for?")
...
def check_stream_order() -> bool:
    ...
    events = _read_events("What companies has Marcus worked for?")
...
- Ask a document question (e.g. "What companies has Marcus worked for?") → answer text appears incrementally (dots → streaming text → caret disappears at end); "Sources" list renders.
